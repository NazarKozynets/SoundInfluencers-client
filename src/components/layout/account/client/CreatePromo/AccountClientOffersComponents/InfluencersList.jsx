...
const InfluencersList = ({influencers, activeIndices, setActiveIndices, selectInfluencer}) => {
        ...
        <ul className="account-client-choose-list">
            {influencers.map((item, index) => (
                ...
                >
                    ...
                    <div className={`account-client-choose-item-content ${item.connect ? "connect" : ""} ${activeIndices.includes(index) && !item.connect ? 'active' : ''} ${flippedAccountIndex === index ? 'flipped' : ''}`}>
                        <ImageWithFallback
                            src={item.logo}
                            fallbackSrc={altLogo}
